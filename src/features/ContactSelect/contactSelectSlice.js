    ...
    reducers:{
        selectContact:(state, action)=>{
            ...
            if(action.payload < arr.length){
                ...
                if(state.previouslySelected!==-1 && state.previouslySelected!==action.payload){
...
export const {selectContact, addContacts, resetContact, deselectContact} = contactSelectSlice.actions   