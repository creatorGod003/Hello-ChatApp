        ...
        <div className='min-h-screen bg-gradient-to-b to-teal-300 from-indigo-500 flex flex-col justify-center items-center'>
            <div className="flex flex-col w-[70%] sm:w-[40%] md:w-[30%] lg:w-[25%] mx-auto border border-slate-800 rounded-2xl shadow-2xl p-2 bg-white">
                <form action="" className="flex flex-col items-left">
                    <label htmlFor="email" className="flex flex-col font-bold text-slate-800">
                        <span className='m-2 '>Email</span>
                        <span className={`${requireEmail ? "block" : "hidden"} text-red-500 m-2`}>*Required</span>
                        <input
                            autoComplete={"on"}
                    ...
                    <label htmlFor="password" className="flex flex-col font-bold text-slate-800">
                        
                        <span className='m-2 '>Password</span>
                        <span className={`${requirePassword ? "block" : "hidden"} text-red-500 m-2`}>*Required</span>
                        <input
                            className="m-2 p-3 border border-slate-600 rounded-md bg-slate-100 placeholder-gray-600  font-normal"
                            onChange={(e) => {
                ...
                <div className="mx-auto my-2 text-sm">Don't have an account? <Link to={"/signup"} className="underline font-bold">Sign Up</Link></div>
            </div>
        </div>
    )
}
